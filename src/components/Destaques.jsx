    ...
    <section className="mx-auto max-w-7xl px-4 py-24 lg:px-8 lg:py-28 relative overflow-hidden" style={{backgroundColor: '#FFFFFF'}} aria-label="Destaques">
      <div className="relative z-10">
        <div className="text-center mb-16">
          <p className="text-xs font-semibold uppercase tracking-[0.05em] mb-4" style={{color: '#E07B24', letterSpacing: '0.05em'}}>Destaques</p>
          ...
          {destaques.map((destaque, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <p className="text-xs font-semibold uppercase tracking-[0.05em] mb-2" style={{color: '#E07B24', letterSpacing: '0.05em'}}>{destaque.badge}</p>
