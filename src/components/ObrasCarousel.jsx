      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        >
          <div className="relative overflow-hidden rounded-2xl" style={{minHeight: '500px'}}>
            <div className="grid lg:grid-cols-2 gap-0 h-full" style={{minHeight: '500px'}}>
              {/* Image */}
              <div className="relative overflow-hidden bg-gray-900" style={{minHeight: '300px'}}>
            ...
            <button
              onClick={prevSlide}
              className="absolute left-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-white/90 shadow-lg hover:bg-white transition-all flex items-center justify-center"
            >
            ...
            <button
              onClick={nextSlide}
              className="absolute right-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-white/90 shadow-lg hover:bg-white transition-all flex items-center justify-center"
            >
              <svg className="h-5 w-5 text-gray-900" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
